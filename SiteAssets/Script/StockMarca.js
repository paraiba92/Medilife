...
var elementos = SPD_GetListItems_CamlQuery(_spPageContextInfo.webAbsoluteUrl, MD_STOCK, viewXml2).results;
...
function _procesar_() {
    ...
    if (_indexData < elementosMarcaStock.length) {
        ...
        var elementos = SPD_GetListItems_CamlQuery(_spPageContextInfo.webAbsoluteUrl, MD_STOCK, viewXml3).results;
