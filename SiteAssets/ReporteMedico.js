    ...
    myAngApp.controller('spResultado', function ($scope, $location, $http, $anchorScroll, $timeout) {
        ...
        $scope.ejecutarWS = function () {
            ...
            $timeout(function () {
                ...
                var viewXml = {
                    ViewXml: "<View><Query><Where></Where><OrderBy><FieldRef Name='Title' Ascending='True' /></OrderBy></Query></View>"
                }

                var elementos = SPD_GetListItems_CamlQuery(_spPageContextInfo.webAbsoluteUrl, MD_MEDICO, viewXml).results;
