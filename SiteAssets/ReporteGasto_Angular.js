    ...
    myAngApp.controller('spResultado', function ($scope, $location, $http, $anchorScroll, $timeout) {
        ...
        $scope.ejecutarWS = function () {
            ...
            $timeout(function () {
                ...
                var elementos = SPD_GetListItems_CamlQuery(_spPageContextInfo.webAbsoluteUrl, MD_GASTOSINFORMALES, viewXml).results;
...
function DevolverNodos() {
    ...
    if (sp_controls.EmitidoHasta.val() != "") {
